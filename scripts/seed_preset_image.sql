...
INSERT INTO preset_image (image_url, gender, voice) VALUES
  ...
  ('https://callfromai-images.s3.ap-northeast-2.amazonaws.com/female_8.png',  'FEMALE', 'SOHYUN'),
  ('https://callfromai-images.s3.ap-northeast-2.amazonaws.com/female_9.png',  'FEMALE', 'SUJIN'),
  ('https://callfromai-images.s3.ap-northeast-2.amazonaws.com/female_10.png', 'FEMALE', 'YEJI'),
  ('https://callfromai-images.s3.ap-northeast-2.amazonaws.com/female_11.png', 'FEMALE', 'EUNSEO'),
  ...
  ('https://callfromai-images.s3.ap-northeast-2.amazonaws.com/male_8.png',    'MALE',   'SEONGHOON'),
  ('https://callfromai-images.s3.ap-northeast-2.amazonaws.com/male_9.png',    'MALE',   'SIYOON'),
  ('https://callfromai-images.s3.ap-northeast-2.amazonaws.com/male_10.png',   'MALE',   'SINU'),
  ('https://callfromai-images.s3.ap-northeast-2.amazonaws.com/male_11.png',   'MALE',   'JIHUN');
